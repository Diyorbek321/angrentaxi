...
/**
 * Session cookies for the dispatcher panel.
 *
 ...
 *
 * `manager_token` keeps the name the panel has always used, so an old
 ...
 */
export const ACCESS_TOKEN_COOKIE = 'manager_token';
export const REFRESH_TOKEN_COOKIE = 'manager_refresh_token';
