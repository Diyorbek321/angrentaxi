...
export const THEME_STORAGE_KEY = 'angren-market-theme';
 ...
 *
 * Doing this in a component instead is the trap the task spec warns about:
 * reading localStorage during render gives one value on the server (none) and
 * another on the client, which is a hydration mismatch. Here the DOM is
 * mutated before React ever looks at it, and <html> carries
