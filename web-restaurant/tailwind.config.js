...
module.exports = {
  darkMode: 'class',
  // web-restaurant: hamma kod `src/` ostida.
  ...
  theme: {
    extend: {
      ...
      // web-restaurant buyurtma holatlari YANGI rang KIRITMAYDI — ular
      // mavjud semantik tokenlarga bog'langan (src/lib/order-status.ts):
      //   new → info · preparing → override (amber) · ready → primary/mint
      //   delivered → muted · cancelled → danger
      // Rang yolg'iz ma'no tashimaydi: har bir holat ikonka + yozuv bilan
      // ham beriladi.
      //
      // Oshxona ekrani telefon/planshetdan ko'riladi, shuning uchun tegish
      // maydonlari uchun minimal o'lcham (WCAG 2.5.5 → 44px).
      minHeight: {
        touch: '44px',
      },
      minWidth: {
