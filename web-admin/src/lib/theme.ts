...
export const THEME_STORAGE_KEY = 'angren-admin-theme';
 ...
 *
 * Doing this in a component instead is the trap: reading localStorage during
 * render gives one value on the server (none) and another on the client, which
 * is a hydration mismatch. Here the DOM is mutated before React ever looks at
 * it, and <html> carries suppressHydrationWarning so React ignores the extra
 * class.
 */
